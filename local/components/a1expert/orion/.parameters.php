...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"ELEMENT_FIELDS_FILTER" => CIBlockParameters::GetFieldCode("Фильтр по полям для элементов", "DATA_SOURCE"),
		"ELEMENT_PROPERTY_FILTER" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => "Фильтр по свойствам для элементов",
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"VALUES" => "",
			"ADDITIONAL_VALUES" => "Y",
		...
		"DISPLAY_EDITOR_BUTTONS" => Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("IBLOCK_ELEMENT_EDITOR"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"SECTION_COUNT" => array(
